export class Constants {
    ...
    public static LIST_ADMIN_MENU = [
        { color: '#EF5350', link: '/admin/dashboard', icon: 'dashboard', title: 'Dashboard', hideFromDashboard: true },
        { color: '#EF5350', link: '/admin/barang', icon: 'inbox', title: 'Barang' },
        { color: '#AB47BC', link: '/admin/pegawai', icon: 'group', title: 'Pegawai' },
        { color: '#5C6BC0', link: '/admin/supplier', icon: 'shopping_cart', title: 'Supplier' },
        { color: '#29B6F6', link: '/admin/permintaan', icon: 'save_alt', title: 'Permintaan' },
        { color: '#26A69A', link: '/admin/pembelian', icon: 'payments', title: 'Pembelian' },
        { color: '#9CCC65', link: '/admin/pengiriman', icon: 'send', title: 'Pengiriman' },
